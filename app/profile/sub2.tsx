      ...
      if (index) {
        try {
          ...
          if (isMounted && !abortController.signal.aborted) {
            ...
            const shouldShow = await CardGenerationService.shouldShowGenerateButtonForPage(parseInt(index.toString()), 'sub2');
  ...
  const handleGenerateCards = async () => {
    ...
    try {
      ...
      if (result.success) {
        ...
        // Check if requested category (identity) was found
        const requestedCategoryFound = generatedCategoryScreenPairs.some(({ category: cat }) => 
          ['background', 'career', 'public image', 'accomplishments', 'statements', 'awards', 'more'].includes(cat)
        );
        ...
        const shouldShow = await CardGenerationService.shouldShowGenerateButtonForPage(ownerId, 'sub2');
        setShowGenerateButton(shouldShow);
        ...
        <View style={styles.softGridContainer}>
          <View style={styles.softGridRow}>
            <AnimatedPressable
              ...
              onPress={() => handleGridButtonPress('Background')}
              style={[
                styles.gridButton1,
                { transform: [{ scale: gridButton1Scale }] }
              ]}
            >
              <Text style={styles.gridButtonText1}>Background</Text>
            </AnimatedPressable>
            <AnimatedPressable
              onPressIn={() => {
                Haptics.selectionAsync();
              ...
              onPress={() => handleGridButtonPress('Career')}
              style={[
                styles.gridButton2,
          ...
          <View style={styles.softGridRow}>
            <AnimatedPressable
              ...
              onPress={() => handleGridButtonPress('Public Image')}
              style={[
                styles.gridButton3,
                { transform: [{ scale: gridButton3Scale }] }
              ]}
            >
              <Text style={styles.gridButtonText3}>Public Image</Text>
            </AnimatedPressable>
            <AnimatedPressable
              onPressIn={() => {
                Haptics.selectionAsync();
              ...
              onPress={() => handleGridButtonPress('Beliefs')}
              style={[
                styles.gridButton4,
                { transform: [{ scale: gridButton4Scale }] }
              ]}
            >
              <Text style={styles.gridButtonText4}>Beliefs</Text>
            </AnimatedPressable>
          </View>
        </View>
      );
        ...
        <View style={styles.gridContainer}>
          ...
          <View style={styles.gridRow}>
            ...
            <AnimatedPressable
              ...
              onPress={() => handleGridButtonPress('Accomplishments')}
              style={[
                styles.gridButton4,
                { transform: [{ scale: gridButton4Scale }] }
              ]}
            >
              <Text style={styles.gridButtonText4}>Accomplishments</Text>
            </AnimatedPressable>
          </View>
          <View style={styles.gridRow}>
            <AnimatedPressable
              ...
              onPress={() => handleGridButtonPress('Statements')}
              style={[
                styles.gridButton5,
                { transform: [{ scale: gridButton5Scale }] }
              ]}
            >
              <Text style={styles.gridButtonText5}>Statements</Text>
            </AnimatedPressable>
            <AnimatedPressable
              onPressIn={() => {
                Haptics.selectionAsync();
              ...
              onPress={() => handleGridButtonPress('Awards')}
              style={[
                styles.gridButton6,
                { transform: [{ scale: gridButton6Scale }] }
              ]}
            >
              <Text style={styles.gridButtonText6}>Awards</Text>
            </AnimatedPressable>
          </View>
